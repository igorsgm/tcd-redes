		...
		<?php endif; ?>
			...
			<div class="texto">
				<?php if ($params->get('itemTitle')): ?>
					<a class="moduleItemTitle" href="<?php echo $item_link; ?>"><h4><?php echo $item->title; ?></h4></a>
				<?php endif; ?>
			...
			<?php if(($params->get('itemReadmore') == '1' )): ?>
				<div class="btn-group moduleItemReadMore">
					...
					<a class="<?php echo JText::_('MOD_LATEST_NEWS_PLUS_ITEM_READMORE_BUTTON_CLASS'); ?>" href="<?php echo $item_link; ?>">
						<?php
