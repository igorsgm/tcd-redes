...
<div class="blog<?php echo $this->pageclass_sfx; ?>" itemscope itemtype="http://schema.org/Blog">
	<?php if ($this->params->get('show_page_heading', 1)) : ?>
		<div class="page-header">
			<h1> <?php $pageTitle = $this->escape($this->params->get('page_heading')); echo $pageTitle; ?> </h1>
		</div>
	<?php endif; ?>
		...
		<?php foreach ($this->intro_items as $key => &$item) : ?>
			...
			<div class="col-sm-<?php echo round((12 / $this->columns)); ?>">
				<article class="item column-<?php echo $rowcount; ?><?php echo $item->state == 0 ? ' system-unpublished' : null; ?><?php echo $item->featured ? ' item-featured' : ''; ?>"
					...
					<?php
					$this->item = & $item;
					$this->item->created_by_alias = $pageTitle == 'Artigos' ? 'Autor(a): ' . $this->item->created_by_alias: 'Fonte: ' . $this->item->created_by_alias;
					$this->item = & $item;
					echo $this->loadTemplate('item');
					?>
				</article>
