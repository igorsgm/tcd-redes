...
<?php if (json_decode($this->item->metadata)->author) { ?>
	<span><?php echo json_decode($this->item->metadata)->author; ?></span>
<?php } ?>
<?php if ($this->item->created_by_alias) { ?>
	<br /><span><?php echo 'Fonte: ' . $this->item->created_by_alias; ?></span>
<?php } ?>
<!-- Fim do autor do item -->
	...
	if ($post_format == 'standard') {
		if (!empty($images->image_intro_alt)) { ?>
			<span class="itemImageCredits"><?php echo $images->image_intro_alt; ?></span>
		<?php }
		echo $getImage;
	} else {
		if ($post_format != 'audio') {
			echo JLayoutHelper::render('joomla.content.post_formats.post_' . $post_format,
