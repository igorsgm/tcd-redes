...
<div class="collapse" id="menu-associado">
	<form action="<?php echo JRoute::_(JUri::getInstance()->toString(), true, $params->get('usesecure')); ?>" method="post" id="login-form">
		...
		<div id="form-login-username" class="form-group">
			...
			<?php else: ?>
				<input id="modlgn-username" type="text" name="username" maxlength="11"  class="form-control" tabindex="0" size="18" placeholder="<?php echo JText::_('MOD_LOGIN_VALUE_USERNAME') ?>" />
			<?php endif; ?>
		</div>
		...
		<ul class="form-links">
			<li>
				...
				<i class="fa fa-lock"></i> <?php echo JText::_('MOD_LOGIN_FORGOT_YOUR_PASSWORD'); ?></a>
			</li>
			<li>
				<a href="<?php echo JRoute::_('index.php?option=com_suporte&view=chamadoform'); ?>">
