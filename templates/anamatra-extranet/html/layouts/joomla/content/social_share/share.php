...
if( $params->get('social_share') ) {
	...
	echo '<ul>';
	echo JLayoutHelper::render( 'joomla.content.social_share.social.whatsapp', array( 'item'=>$displayData, 'params'=>$params, 'url'=>$url ) );
	...
	echo JLayoutHelper::render( 'joomla.content.social_share.social.linkedin', array( 'item'=>$displayData, 'params'=>$params, 'url'=>$url ) );
	echo '</ul>';
	echo '</div>';
}