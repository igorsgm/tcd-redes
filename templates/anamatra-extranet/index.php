...
$class = str_replace(" ","-",strtolower($pageTitle));
$class = preg_replace('/[^a-z,-]/i', '', iconv("UTF-8", "US-ASCII//TRANSLIT", $class));
?>
<body class="extranet <?php echo $this->helix3->bodyClass( $body_classes ); ?> <?php echo $class;?>">
