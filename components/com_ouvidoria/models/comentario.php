 ...
 * @since  1.6
 */
class OuvidoriaModelComentario extends JModelItem
{
	/**
	...
	public function &getData($id = null)
	{
		...
		if (isset($this->_item->id_user_consultado)) {
			$this->_item->user_consultado_name = JFactory::getUser($this->_item->id_user_consultado)->name;
		}
