...
<div class="solicitante-edit front-end-edit">
	<?php if (!$canEdit) : ?>
		<h3>
	...
	<?php else : ?>
		...
		<form id="form-solicitante"
			...
			<?php foreach ((array)$this->item->id_associado as $value): ?>
			...
			<?php foreach ((array)$this->item->id_user as $value): ?>
				<?php if (!is_array($value)): ?>
			...
			<div class="control-group">
				<div class="controls">
					...
					<?php endif; ?>
					<a class="btn"
					   href="<?php echo JRoute::_('index.php?option=com_ouvidoria&task=solicitanteform.cancel'); ?>"
