...
/**
 * Dispositivo controller class.
 *
 * @since  1.6
 */
class DispositivosControllerDispositivoForm extends JControllerForm
{
	/**
	...
	public function edit($key = null, $urlVar = null)
	{
		...
		$app->setUserState('com_dispositivos.edit.dispositivo.id', $editId);
		...
		$this->setRedirect(JRoute::_('index.php?option=com_dispositivos&view=dispositivoform&layout=edit', false));
	}
	...
	public function save($key = null, $urlVar = null)
	{
		...
		$this->setMessage(JText::_('COM_DISPOSITIVOS_ITEM_SAVED_SUCCESSFULLY'));
