...
$canCreate  = $user->authorise('core.create', 'com_dispositivos') && file_exists(JPATH_COMPONENT . DIRECTORY_SEPARATOR . 'models' . DIRECTORY_SEPARATOR . 'forms' . DIRECTORY_SEPARATOR . 'dispositivoform.xml');
$canEdit    = $user->authorise('core.edit', 'com_dispositivos') && file_exists(JPATH_COMPONENT . DIRECTORY_SEPARATOR . 'models' . DIRECTORY_SEPARATOR . 'forms' . DIRECTORY_SEPARATOR . 'dispositivoform.xml');
$canCheckin = $user->authorise('core.manage', 'com_dispositivos');
$canChange  = $user->authorise('core.edit.state', 'com_dispositivos');
$canDelete  = $user->authorise('core.delete', 'com_dispositivos');
?>
