 ...
 * @since  1.6
 */
class DispositivosModelDispositivoForm extends JModelForm
{
	private $item = null;
	...
	protected function populateState()
	{
		...
		$this->setState('dispositivo.id', $id);
	...
	{
		$this->addTablePath(JPATH_ADMINISTRATOR . '/components/com_dispositivos/tables');
	...
	{
		// Get the form.
		$form = $this->loadForm('com_dispositivos.dispositivo', 'dispositivoform', array(
				'control'   => 'jform',
				'load_data' => $loadData
			)
		);
