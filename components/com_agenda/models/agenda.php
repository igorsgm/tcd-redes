 ...
 * Agenda model.
 */
class AgendaModelAgenda extends JModelItem {
    ...
    protected function populateState() {
        $app = JFactory::getApplication('com_agenda');

        // Load state from the request userState on edit or from the passed variable on default
        if (JFactory::getApplication()->input->get('layout') == 'edit') {
            $id = JFactory::getApplication()->getUserState('com_agenda.edit.agenda.id');
        } else {
            $id = JFactory::getApplication()->input->get('id');
            JFactory::getApplication()->setUserState('com_agenda.edit.agenda.id', $id);
        }
