...
class AssociadosControllerAssociado extends JControllerLegacy
{
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('Associado', 'AssociadosModel');
	...
	public function publish()
	{
		...
		if ($user->authorise('core.edit', 'com_associados') || $user->authorise('core.edit.state', 'com_associados'))
		{
			$model = $this->getModel('Associado', 'AssociadosModel');
	...
	public function remove()
	{
		...
		if ($user->authorise('core.delete', 'com_associados'))
		{
			$model = $this->getModel('Associado', 'AssociadosModel');
