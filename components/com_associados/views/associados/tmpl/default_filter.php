	...
	<div class="clearfix">
		<div class="js-stools-container-bar">
			<label for="filter_search" class="sr-only"
				aria-invalid="false"><?php echo JText::_('COM_ASSOCIADOS_SEARCH_FILTER_SUBMIT'); ?></label>

			<div class="btn-wrapper input-append">
				<?php echo $search_filter->input; ?>
				<button type="submit" class="btn btn-primary hasTooltip" title=""
					data-original-title="<?php echo JText::_('COM_ASSOCIADOS_SEARCH_FILTER_SUBMIT'); ?>">
			...
			<?php if ($filters): ?>
				<div class="btn-wrapper hidden-phone">
					<button type="button" class="btn btn-info hasTooltip js-stools-btn-filter" title=""
						data-original-title="<?php echo JText::_('COM_ASSOCIADOS_SEARCH_TOOLS_DESC'); ?>">
						<?php echo JText::_('COM_ASSOCIADOS_SEARCH_TOOLS'); ?> <i class="caret"></i>
					</button>
				</div>
			<?php endif; ?>

			<div class="btn-wrapper">
				<button type="button" class="btn btn-warning hasTooltip js-stools-btn-clear" title=""
					data-original-title="<?php echo JText::_('COM_ASSOCIADOS_SEARCH_FILTER_CLEAR'); ?>"
					onclick="jQuery(this).closest('form').find('input').val('');">
					<?php echo JText::_('COM_ASSOCIADOS_SEARCH_FILTER_CLEAR'); ?>
				</button>
			</div>
		</div>
		<div class="btn-wrapper pull-right">
				<a href="index.php?option=com_associados&view=associados&tpl=excelassociados&tmpl=component" class="btn btn-success">
					<i class="fa fa-download"></i> Gerar Excel <b>Associados</b>
				</a>
			</div>
		<div class="btn-wrapper pull-right">
			<a target="_blank" href="index.php?option=com_associados&view=associados&tpl=etiquetas&tmpl=component" class="btn btn-danger">
				<i class="fa fa-print"></i> Imprimir etiquetas
			</a>
		</div>
	</div>
	<!-- Filters div -->
	<div class="js-stools-container-filters hidden-phone clearfix associado-edit" style="">
