...
/**
 * Solicitacoes list controller class.
 *
 * @since  1.6
 */
class OuvidoriaControllerSolicitacoes extends JControllerAdmin
{
	/**
	 * Method to clone existing Solicitacoes
	 *
	 * @return void
	 */
	 ...
	 * @since    1.6
	 */
	public function getModel($name = 'solicitacao', $prefix = 'OuvidoriaModel', $config = array())
	{
