 ...
 * @since  1.6
 */
class OuvidoriaControllerComentarios extends JControllerAdmin
{
	/**
	 * Method to clone existing Comentarios
	 *
	 * @return void
	 */
	 ...
	 * @since    1.6
	 */
	public function getModel($name = 'comentario', $prefix = 'OuvidoriaModel', $config = array())
	{
