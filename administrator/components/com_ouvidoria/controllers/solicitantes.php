...
/**
 * Solicitantes list controller class.
 *
 * @since  1.6
 */
class OuvidoriaControllerSolicitantes extends JControllerAdmin
{
	/**
	 * Method to clone existing Solicitantes
	 *
	 * @return void
	 */
	 ...
	 * @since    1.6
	 */
	public function getModel($name = 'solicitante', $prefix = 'OuvidoriaModel', $config = array())
	{
