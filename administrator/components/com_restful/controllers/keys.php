 ...
 * @since  1.6
 */
class RestfulControllerKeys extends JControllerAdmin
{
	/**
	 * Method to clone existing Keys
	 *
	 * @return void
	 */
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_restful&view=keys');
	}
	 ...
	 * @since    1.6
	 */
	public function getModel($name = 'key', $prefix = 'RestfulModel', $config = array())
	{
