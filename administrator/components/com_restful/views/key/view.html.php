 ...
 * @since  1.6
 */
class RestfulViewKey extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_RESTFUL_TITLE_KEY'), 'key.png');
		...
		if (!$isNew && $canDo->get('core.create')) {
			JToolBarHelper::custom('key.save2copy', 'save-copy.png', 'save-copy_f2.png', 'JTOOLBAR_SAVE_AS_COPY',
				false);
		}

		// Button for version control
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_restful.key', $this->item->id);
		}
