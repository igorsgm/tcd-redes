...
class AgendaViewAgendas extends JViewLegacy {
    ...
    protected function addToolbar() {
        require_once JPATH_COMPONENT . '/helpers/agenda.php';

        $state = $this->get('State');
        $canDo = AgendaHelper::getActions($state->get('filter.category_id'));

        JToolBarHelper::title(JText::_('COM_AGENDA_TITLE_AGENDAS'), 'agendas.png');
        ...
        if ($canDo->get('core.admin')) {
            JToolBarHelper::preferences('com_agenda');
        }

        //Set sidebar action - New in 3.0
        JHtmlSidebar::setAction('index.php?option=com_agenda&view=agendas');
		...
		JHtmlSidebar::addFilter(
			...
			'filter_categoria',
			JHtml::_('select.options', JHtml::_('category.options', 'com_agenda'), "value", "text", $this->state->get('filter.categoria'))
	...
	protected function getSortFields()
	{
		...
		'a.categoria' => JText::_('COM_AGENDA_AGENDAS_CATEGORIA'),
		'a.nome' => JText::_('COM_AGENDA_AGENDAS_NOME'),
		'a.local' => JText::_('COM_AGENDA_AGENDAS_LOCAL'),
		'a.data_inicio' => JText::_('COM_AGENDA_AGENDAS_DATA_INICIO'),
		'a.data_fim' => JText::_('COM_AGENDA_AGENDAS_DATA_FIM'),
		);
	}
