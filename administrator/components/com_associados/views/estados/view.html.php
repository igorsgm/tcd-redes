 ...
 * @since  1.6
 */
class AssociadosViewEstados extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		AssociadosHelpersAssociados::addSubmenu('estados');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_ASSOCIADOS_TITLE_ESTADOS'), 'estados.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_associados&view=estados');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`sig_estado`' => JText::_('COM_ASSOCIADOS_ESTADOS_SIG_ESTADO'),
		);
	}
}
