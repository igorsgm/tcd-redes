 ...
 * @since  1.6
 */
class AssociadosViewEstado extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_ASSOCIADOS_TITLE_ESTADO'), 'estado.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_associados.estado', $this->item->id);
		}
